...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run one five-seat Sold 'Em match")
    ap.add_argument("strategies", nargs=5, help="Five strategy tags or Python file paths")
    ...
    ap.add_argument("--compact-log", default="")
    ...
    result = run_match(
        ...
        compact_log_path=args.compact_log or None,
    )
